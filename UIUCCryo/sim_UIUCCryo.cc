...
int main(int argc, char** argv)
{
  ...
  //
  G4cout << "Creating detector_UIUCCryo object" << G4endl;
  detector_UIUCCryo* detector = new detector_UIUCCryo;
  runManager->SetUserInitialization(detector);
  //
  UIUCCryoPhysicsList* physics = new UIUCCryoPhysicsList;
...
//  runManager->SetUserAction(track_action);
  ...
  G4UserSteppingAction* step_action = new UIUCCryoSteppingAction;
