...
int main(int argc, char** argv)
{
  ...
  //
  G4cout << "Creating detector_mcgregor90 object" << G4endl;
  detector_mcgregor90* detector = new detector_mcgregor90;
  runManager->SetUserInitialization(detector);
  //
  examplePhysicsList* physics = new examplePhysicsList;
